...
export class AccountsComponent implements OnInit {
  ...
  fetchAccountData() {
    ...
    this._api.getTypeRequest('accounts/fetch-accounts?' + param).subscribe((res: any) => {
...
checkEditable(month, year) {
  ...
  if ((newMonth === parseInt(month) || month === undefined) && (newYear === parseInt(year) || year === undefined)) {
    return 'Edit';
  } else {
    return 'View';
  }
